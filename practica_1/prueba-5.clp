...
(definstances sesion
  ...
  ([game_3] of SESION (nombre juego_inventado))
)
...
(definstances personalidad
  ...
  ([ninio_4] of PERSONALIDAD (personalidad inventada) (ninio llora) (robot tranquilizarse))
  ([ninio_5] of PERSONALIDAD (personalidad inventada) (ninio duerme) (robot despierta))

)

(definstances juego_imitar

  ([imita_1] of JUEGOS (nombre imita_al_robot) (pose inventada))
  ([imita_2] of JUEGOS (nombre imita_al_robot) (pose inventada2) )
